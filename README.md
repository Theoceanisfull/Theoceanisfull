...
- **pandas** – Advanced data wrangling, aggregation, and time-series operations  
- **NumPy** – Vectorized computations, matrix operations, numerical optimization  
- **SQL (PostgreSQL, SQLite)** – Data extraction, joins, filtering, and performance-aware querying  
- **Power Query (M Language)** – Complex transformations in Power BI  
- **Regular Expressions (regex)** – Pattern matching for rule-based text parsing

---

### 📈 Visualization & Reporting
- **matplotlib** / **seaborn** / **plotly** – Custom static and statistical visualizations  
- **Power BI** – Interactive dashboards, DAX logic, KPI development  
- **Tableau** – Visual storytelling, calculated fields, and trend analysis  

---

### 🤖 Machine Learning & AI
- **scikit-learn** – Model selection, cross-validation, feature engineering, and evaluation metrics  
- **Hugging Face Transformers** – Fine-tuning transformer models (e.g., BERT, GPT, RoBERTa) for NLP tasks  
- **PyTorch** – Deep learning, custom training loops, and model optimization  
- **TensorFlow / Keras** – Rapid prototyping of neural networks and experimentation  
- **LoRA / PEFT** – Parameter-efficient fine-tuning for large-scale LLM adaptation  
- **OpenAI GPT / Generative AI** – Prompt design, inference, and decision-support applications  
- **Aspect-Based Sentiment Analysis (ABSA)** – Rule-based and model-based topic sentiment analysis
...
- **Python (core + libraries)** – Modular scripting, automation, object-oriented design  
- **Git & GitHub** – Version control, feature branching, and collaborative workflows  
- **Jupyter Notebooks** – Iterative experimentation, prototyping, and visualization

---

### ☁️ Infrastructure & DevOps
- **AWS** (EC2, S3, IAM, VPC, CloudFormation) – Scalable architecture for ML deployment  
- **Docker (basic)** – Containerizing apps and reproducible development environments  
- **Linux (zsh / bash)** – Shell scripting, file operations, and environment control
